...
extension ViewController: ARSCNViewDelegate {
    ...
    func displayDetailView(on rootNode: SCNNode, xOffset: CGFloat) {
        ...
        detailNode.geometry?.firstMaterial?.diffuse.contentsTransform = SCNMatrix4Translate(SCNMatrix4MakeScale(-1, 1, -1), 1, 0, 1)
    ...
    func displayWebView(on rootNode: SCNNode, xOffset: CGFloat) {
        ...
        DispatchQueue.main.async {
            let request = URLRequest(url: URL(string: "https://www.litres.ru/alina-sinichkina/biznes-haki-sekretnyy-opyt-uspeshnyh-predprinimateley-ros/chitat-onlayn/#overview")!)
            ...
            webViewNode.geometry?.firstMaterial?.diffuse.contentsTransform = SCNMatrix4Translate(SCNMatrix4MakeScale(-1, -1, -1), 1, 1, 1)
            
            webViewNode.position.z -= -1
